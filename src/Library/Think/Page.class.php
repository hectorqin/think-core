...
class Page
{
     ...
     */
    public function __construct($totalRows, $listRows = 20, $parameter = array(), $varPage = '')
    {
        C('VAR_PAGE') && $this->p = C('VAR_PAGE'); //设置分页参数名称
        //THINK_CHANGE_BEGIN  新增page类支持自定义分页参数名
        if ($varPage) {
            $this->p = $varPage;
        }
        ...
        $this->parameter = empty($parameter) ? (!empty($_POST) ? $_POST : $_GET) : $parameter;
